...
class LevelMatrixes {
    ...
    class func getMatrixLevel(level: Int) -> Array<Array<Int>> {
        ...
        if(level==0) {
            ...
            var nextMatrix = [[4,4,4,2,0,0,0]]
            nextMatrix.append([0,0,0,0,0,0,0])
            nextMatrix.append([11,11,5,5,5,5,5])
            nextMatrix.append([11,11,5,5,5,5,5])
            nextMatrix.append([11,11,11,5,5,5,5])
            nextMatrix.append([5,11,11,11,5,5,5])
            nextMatrix.append([5,11,11,11,5,5,5])
        ...
        if(level==26) {
            ...
            var nextMatrix = [[5,5,5,5,5,5,5]]
            nextMatrix.append([5,0,0,0,0,0,2])
